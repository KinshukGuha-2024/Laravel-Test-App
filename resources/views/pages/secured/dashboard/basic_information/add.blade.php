...
<head>
    ...
    <title>{{ config('app.name') }} | Add Basic Information</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid" style="padding: 20px;">
                        <form id="form" class="form" method="POST" enctype="multipart/form-data" action="{{ route('secured.basic.info.save.post') }}">
                            ...
                            <div class="image-container" style="display: flex; flex: 3; justify-content: left; gap: 20px;">
                                <div style="flex: 1;">
                                ...
                                <div style="flex: 3;">
                                    ...
                                    <textarea  name="about" id="about" style="min-height:150px;"  class="form-control">{{ old('about') }}</textarea>
                                    @if ($errors->has('about'))
                                        <div class="text-danger">
