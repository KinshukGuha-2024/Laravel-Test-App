                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="font-weight: bold;">Otto</td>
                                    <td style="font-weight: bold;">@mdo</td>
                                    <td><img style="width: 25px;height: 25px; cursor:pointer;" title="View Full Mail" src="{{ asset('storage/images/assets/icons/eye.png') }}" alt=""></td>
                                </tr>
                            </tbody>
                        </table> 
                    </div>
